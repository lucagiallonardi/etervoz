...
const AboutComp = () => {
  return (
    <div className={style.aboutContainer} id='about'>
        <div><h1>About us</h1><p>Somos Belén Heredia y Ezequiel Álvarez, locutores, actores de voz y emprendedores con amplio conocimiento en diseño sonoro y post producción de audio. Realizamos audiolibros, doblaje, comerciales, cursos en línea, institucionales, centrales telefónicas y pre-atendedores.  Nos enfocamos en mantener siempre la excelencia y compromiso con las fechas de entrega de tu proyecto.</p>
